...
const POOL = [
  ...
  { name: "Кекс228",  c: 114, persona: "Молодой парень, играет на чуйке, лёгкий и беззлобный.", style: "молодёжный сленг, коротко, без мата и без хамства",
  ...
  { name: "ЗмеЮка",   c: 205, persona: "С лёгкой иронией и юмором, но не злая.", style: "мягкая ирония и добрые подколы, без грубости",
