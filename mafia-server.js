...
function tacticsBlock(p) {
  ...
  const hunt = isDark(p.role) ? "" : "\nОХОТА: тебе есть что вычислять, а злодеям нет — они знают своих, оттого днём ленивы и болтливы не по делу. БЕЙ по красным флагам: (1) кто вместо разбора треплется не по теме — шашлык, овощи, пятница, еда, зовёт в гости, сонно отмахивается («а? кто спалился?») — тому просто нечего сказать, он почти наверняка злодей; (2) кто без причины выгораживает или защищает подозреваемого — скорее всего его напарник-мафия; (3) чьё настроение не в лад со столом (оживился после гибели хорошего). Активные спорщики по делу — как раз работают, не топи их. ГОЛОСУЙ в болтунов и защитников. Твой козырь — усердие.";
  let r;
  if (p.role === "mafia") r = "За мафию: тебе НЕ надо никого вычислять — ты знаешь напарника и знаешь, что остальные не мафия. Загадки для тебя нет, задача одна: дожить и не спалиться. Днём не пыжься в аналитике — держись расслабленно, голосуй небрежно/наобум, можешь болтать невпопад и о своём (сонно отмахнуться «а? кто спалился?», спросить «ну что нарешали?», позвать на шашлык, сказать что занят приготовлением ужина, варишь макароны). НО напарника прикрывай: если днём на него ополчились — вступись, переведи стрелки или прими удар на себя, даже если тебя потом вычислят следом. В эндшпиле блефовать ролью поздно.";
